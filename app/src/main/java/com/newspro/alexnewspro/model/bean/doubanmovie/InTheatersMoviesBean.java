...
public class InTheatersMoviesBean implements Parcelable{
    ...
    protected InTheatersMoviesBean(Parcel in) {
        count = in.readInt();
        start = in.readInt();
        total = in.readInt();
        title = in.readString();
    ...
    public static final Creator<InTheatersMoviesBean> CREATOR = new Creator<InTheatersMoviesBean>() {
        @Override
        public InTheatersMoviesBean createFromParcel(Parcel in) {
            return new InTheatersMoviesBean(in);
        }

        @Override
        public InTheatersMoviesBean[] newArray(int size) {
            return new InTheatersMoviesBean[size];
        }
    };
